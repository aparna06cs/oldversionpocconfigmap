...
public class CartController {
	...
	@Autowired
	private CartConfiguration cartconf;
	...
	@GetMapping("conf/cartsuccess")
    public String cartSuccessmethod() {
        System.out.println("the controoler class config map 2 for 1.5->"+cartconf.getCartSucess());
        return cartconf.getCartSucess();
    }
	
	@GetMapping("conf/cartsuccess1")
    public String cartSuccessmethod1() {
        System.out.println("the controoler class config map 2 for 1.5->"+cartconf.getCartSucess1());
        return cartconf.getCartSucess1();
    }
	
	@GetMapping("conf/cartfailure")
    public String cartfailuremethod() {
        System.out.println("the controoler class config map 2 for 1.5->"+cartconf.getCartFailure());
        return cartconf.getCartFailure();
    }
	
	@GetMapping("conf/cartfailure1")
    public String cartfailuremethod1() {
        System.out.println("the controoler class config map 2 for 1.5->"+cartconf.getFailure1());
        return cartconf.getFailure1();
    }
	
	@GetMapping("conf/success")
    public String cartSuccessmethod3() {
        System.out.println("the controoler class config map 2 for 1.5->"+cartconf.getSuccess());
        return cartconf.getSuccess();
    }
	
	@GetMapping("conf/success1")
    public String cartSuccessmethod4() {
        System.out.println("the controoler class config map 2 for 1.5->"+cartconf.getSuccess1());
        return cartconf.getSuccess1();
    }
	@GetMapping("conf/failure")
    public String cartfailuremethod3() {
        System.out.println("the controoler class config map 2 for 1.5->"+cartconf.getFailure());
        return cartconf.getFailure();
    }
	
	@GetMapping("conf/failure1")
    public String cartfailuremethod4() {
        System.out.println("the controoler class config map 2 for 1.5->"+cartconf.getFailure1());
        return cartconf.getFailure1();
    }
    ...
    public String cartSuccessmethod11() {
        System.out.println("the controoler class config map 2 for 1.5 from contr->"+cartSucess);
        return cartconf.getCartSucess();
    }
